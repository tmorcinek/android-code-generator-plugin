...
public class XmlLayoutParserTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		layoutParser = new XmlLayoutParser(false, "com.morcinek.activities", new TypesAdapter(types));
	}
	
	@Test
	public void testXmlLayoutParserMain() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException {
	...
	@Test
	public void testXmlLayoutParser() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException {
	...
	@Test
	public void testXmlLayoutParserHeader2() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException {
	...
	@Test
	public void testXmlLayoutParserNoHeader() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException {
	...
	@Test
	public void testXmlLayoutParserLayout() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException {
		...
		String layoutActivityString = IOUtils.toString(XmlLayoutParserTest.class.getResourceAsStream("/LayoutActivity.java"));
